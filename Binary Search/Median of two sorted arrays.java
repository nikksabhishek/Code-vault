...
public class MedianOfTwoSortedArrayOfDifferentLength {
    ...
    public double findMedianSortedArrays(int input1[], int input2[]) {
        ...
        while (low <= high) {
            ...
            //if partitionX is 0, left side of the array is empty. Use -INF for maxLeftX
            //if partitionX is length of input, right side of the array is empty. Use +INF for minRightX
